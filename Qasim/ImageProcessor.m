...
- (void)processImage:(UIImage*)inputImage other:(UIImage*)otherImage
{
    UIImage * outputImage = [self processUsingCoreGraphics:inputImage other:otherImage];
...
- (UIImage *)processUsingCoreGraphics:(UIImage*)input other:(UIImage*)otherImage
{
...
//  CGRect transformedGhostRect = CGRectApplyAffineTransform(ghostRect, flipThenShift);
  CGRect transformedGhostRect = CGRectApplyAffineTransform(imageRect, flipThenShift);
